#' 
#' Adapted (er, stolen) from https://github.com/betanalpha/knitr_case_studies/blob/master/fitting_the_cauchy/stan_utility.R
#' on 9/9/2018
#' 
...
check_tail_khat <- function(fit_nom, quiet=FALSE) {
